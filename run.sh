...
./write  -m /dev/sda2 -n log_hhd_stride_write.txt -s 
./write  -m /dev/sda2 -n log_hhd_random_write.txt -b -l 0 -u 25600
./write  -m /dev/sda2 -n log_hhd_normal_read.txt -c
./write  -m /dev/sda2 -n log_hhd_stride_read.txt -s -c
./write  -m /dev/sda2 -n log_hhd_random_read.txt -b -l 0 -u 25600 -c
